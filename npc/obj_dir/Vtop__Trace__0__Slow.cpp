...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+28,"wen_mastatus", false,-1);
    tracep->declBus(c+9,"mepc_wdata", false,-1, 31,0);
    tracep->declBus(c+29,"mtvec_rdata", false,-1, 31,0);
    tracep->declBus(c+30,"mastatus_rdata", false,-1, 31,0);
    tracep->declBus(c+10,"mastatus_wdata", false,-1, 31,0);
    ...
    tracep->declBus(c+30,"mastatus", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+10,(vlSelf->top__DOT__mastatus_wdata),32);
    ...
    bufp->fullBit(oldp+28,(vlSelf->top__DOT__wen_mastatus));
    bufp->fullIData(oldp+29,(vlSelf->top__DOT__gpr__DOT__mtvec),32);
    bufp->fullIData(oldp+30,(vlSelf->top__DOT__gpr__DOT__mastatus),32);
